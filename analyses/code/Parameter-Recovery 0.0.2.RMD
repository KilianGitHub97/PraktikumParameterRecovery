...
```{r, echo=TRUE}
fit.tau.full <- lm(formula = Ztrue_tau ~ Ztau:type + Ztau:Zdiscount + Ztau:nblock + Ztau:Zlambda,
                   data = data.w.mlr)
...
```{r, echo=TRUE}
data.w.discount.mlr <- lm(formula = Zdiscount ~ Ztrue_tau + Z_true_lambda + Ztype + Znblock,
                        data = data.w.mlr)
...
data.w.nblock.mlr <- lm(formula = Znblock ~ Ztrue_tau + Ztrue_lambda + Ztype + Zdiscount,
                        data = data.w.mlr)
